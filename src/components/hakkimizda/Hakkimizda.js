...
function Hakkimizda() {
  useDocumentTitle("Sivas Eliva Beauty Güzellik Salonu");
  return (
      ...
      >
        ...
        <div className="card-body col-12" style={{ padding: "3rem" }}>
          ...
          <p class="hizmetyazi">
            ...
            yüzlü ekibi ile estetik ve güzellik sektöründe Sivas’da merkezi
            ...
            kavuşuyorsunuz. Ailenizden biri olmayı amaçlayan Sivas Lavinya Golden
          ...
          <p class="hizmetyazi">
            ...
            olmak için emin adımlarla, şehrin gözdesi Sivas merkezde ileri seviye hizmet vermektedir. Kadın ve erkeklere özel
            ayrı salonlarımızda, memnuniyet ve sonuç odaklı profesyonel
            uygulamalar yapıyoruz.
          </p>

          <p class="hizmetyazi">
            Sivas Eliva Beauty Güzellik Salonu olarak Lazer Epilasyon, G5
            Masajı, Kavitasyon, Kirpik Lifting, Yosun Peeling,
            Hydrafacial Cilt Bakımı hizmetlerimiz mevcuttur. Kampanyalarımız ve
            detaylar için sosyal medya hesaplarımızı takipte kalın. Sivas
            Eliva Beauty Salonu olarak şehrin merkezinde bulunan
            ...
            müşterimize hizmet verebilmekteyiz.
                ...
                <p className="instaLink" style={{textAlign:"center",color:"gray"}}>Detaylı güncel fotoğraf ve videolar için <a className="instagram"  href="https://www.instagram.com/elivabeauty.Sivas/" target="_blank">Sivas Eliva Beauty Güzellik Salonu</a> instagram profilimizi ziyaret edebilirsiniz. </p>
